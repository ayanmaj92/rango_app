...
def visitor_cookie_handler(request):
	...
	function to obtain the visits cookie.
	...
	# N.B.: All cookie values are returned as strings!!!
	# Here we use response.set_cookie() to actually set custom cookies to the response!!
